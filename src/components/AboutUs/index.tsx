...
function AboutUs() {
  return (
    <div className="p-5 d-flex flex-column justify-content-center align-items-center">
      <h1 className="text-center">Conheça um pouco mais sobre nós</h1>
      <div className="d-flex flex-column flex-md-row gap-3 gap-5 mt-4">
        <img className="d-block" src={"logo"} alt="Logo Orca Diversões" />
        <p className="paragraph">
            Somos a Orca Diversões e Entretenimento, uma empresa localizada em Floriano, PI, especializada no desenvolvimento de brinquedos personalizados e na criação de experiências inesquecíveis para crianças e adultos. Com mais de X anos de atuação no mercado de cenografia e entretenimento, nos destacamos pela nossa paixão em transformar ideias criativas em realidade. <br/><br/>
